...
FULL_TEST_SCENARIOS = [
    {"name": "2_zones_high_availability", "regions": ["us-east-1a_v100_1", "us-east-1c_v100_1"], "traces": [f"{i}.json" for i in range(20)]},
    {"name": "3_zones_high_availability", "regions": ["us-east-1a_v100_1", "us-east-1c_v100_1", "us-east-1d_v100_1"], "traces": [f"{i}.json" for i in range(20)]},
